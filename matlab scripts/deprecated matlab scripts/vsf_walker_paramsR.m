...
socket_limb_offset = [0 0 7.5]; %cm
pylon_radius = 1.5; %cm
pylon_length = lower_leg_length - lower_leg_length_amputated - socket_limb_offset(1)-9; %cm
pylon_density = 50000; %kg/m^3

%Torso parameters (cm)
torso_y = subj1.seg.pelvisY;
torso_x = subj1.seg.pelvisY;
torso_z = subj1.seg.pelvisY;
torso_offset_z = -7;
torso_offset_x = -0.5;
torso_offset_y = .33*leg_radius;
...
% ankle_motionRY = [time,deg2rad(subj1.km.Rankle(:,2))];
