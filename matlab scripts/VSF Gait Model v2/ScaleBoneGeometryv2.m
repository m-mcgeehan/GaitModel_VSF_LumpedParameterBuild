...
FemurR_sf = 1; %subj1.static.segLength.legLengthR/41.58; %Create uniform scaling factor between the generic bone length and the bone length from MoCap
...
FemurL_sf = 1; %subj1.static.segLength.legLengthL/41.58;
...
ShankL_sf = 1; %subj1.static.segLength.shankLengthL/37.25;
...
ShankR_cut_sf = 1; %subj1.static.segLength.shankLengthR/19.0;
...
pelvis_sfX = 1; %subj1.static.segLength.pelvisX/14.5;
pelvis_sfY = 1; %(subj1.static.segLength.ASISYdist/25.8 + subj1.static.segLength.PSISYdist/9.14)/2;
pelvis_sfZ = 1; %(pelvis_sfX+pelvis_sfY)/2;
...
HAT_sf = 1; %(pelvis_sfX + pelvis_sfY + pelvis_sfZ)/3;
...
FootL_sf = 1; %subj1.static.segLength.footLX/21.79;
