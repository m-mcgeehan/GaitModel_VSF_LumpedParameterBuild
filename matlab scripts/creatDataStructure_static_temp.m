...
AJCL = (static.markers.RHLA + static.markers.RHME)/2;
...
%% Estimate kinematics
%pelvis
pelvis_j = (static.markers.pelvisOrigin - static.markers.RASI)/norm(static.markers.pelvisOrigin - static.markers.RASI);
...
%Shank
shankR_k = (static.markers.KJCR - static.markers.AJC_pros)/(norm(static.markers.KJCR - static.markers.AJC_pros));
...
%% Process segment distal and proximal end positions
%% Generate the LCS translational offsets for each segment and save to data structure (from v3d)
...
static.offsets.Pevis2HJCL = static.markers.HJCL - static.markers.pelvisOrigin;
...
static.offsets.LegRL2KJCL = static.markers.KJCL - (static.markers.HJCL + static.offsets.HJCL2LegL);
...
static.offsets.ShankR2AJCL = static.markers.AJCL - (x*(mean(ShankLProxPos{1})'*100));
