...
pylon_length = 100*dynamic.static.segLength.shankLengthL + socket2shank_offset(3) + (dynamic.static.segLength.footLZ- 5.7); %cm
...
if isequal(ModelControl,0)
        ...
        pelvisAngZ = [dynamic.km.TS.pelvisAng_GCS.time, deg2rad(wrapTo360(dynamic.km.TS.pelvisAng_GCS.data(:,3)))];
